...
and summing up the pixel values, a procedure known as aperture photometry. In crowded regions,
...
of interest~\citep{heasley:1999}. PSF photometry can also be applied to
