...
Using the assumption that the data is Poisson distributed, we obtain a mean residual value at the two brightest pixels across 4000 cadences of $9.35 \rpm 4.45 e^{-}/s$. The same analysis with Gaussian likelihood assumption yields $10.11 \rpm 5.76 e^{-}/s$. The mean residuals considering all 30 pixels was $-2.25\cdot 10^{-5} \rpm 12.58e^{-}/s$, and $0.99 \rpm 12.59 e^{-}/s$ for the Poisson and Gaussian assumptions, respectively.
