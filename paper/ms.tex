...
observations. Often it is the case where the astronomical object of interest is isolated
so that aperture photometry can be performed. In crowded regions,
conversely, targets are not disjoint and therefore point spread
function (PSF) photometry is the principled way to obtain meaningful measurements~\citep{heasley:1999}.
